    ...
    : IdentityDbContext<ApplicationUser>(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<NewsArticle>(entity =>
        {
            ...
            entity.Property(article => article.Title).HasMaxLength(250);
            entity.Property(article => article.Slug).HasMaxLength(280);
            entity.Property(article => article.Summary).HasMaxLength(500);
            entity.Property(article => article.Content).HasColumnType("longtext");
            entity.Property(article => article.ImageUrl).HasMaxLength(500);
            entity.HasIndex(article => article.Slug).IsUnique();
            entity.HasIndex(article => new { article.IsFeatured, article.PublishedAt });
        });
    }
}
